...
public class VistActivity extends Activity   {
	...
	@Override
	    public void onCreate(Bundle savedInstanceState) {
			...
			adapter = new GoodsListViewAdapter(VistActivity.this);
	 ...
	 public void loginout_system(View v){
		Intent intent = new Intent(VistActivity.this, LoginActivity.class);
	 ...
	 public final class MyListItemListener implements OnItemClickListener {
			...
			public void onItemClick(AdapterView<?> view, View arg1,
				...
				Toast.makeText(VistActivity.this, "请先登录", Toast.LENGTH_LONG).show();
				VistActivity.this.finish();
